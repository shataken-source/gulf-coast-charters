-- ============================================================================
-- CHARTER BOOKING PLATFORM - ONE-CLICK MASTER SETUP
-- ============================================================================
-- Run this entire file in Supabase SQL Editor to create everything
...
-- ============================================================================
-- 7. COMMUNITY POINTS & GAMIFICATION
-- ============================================================================
...
BEGIN
    ...
    -- Check for new badges (simplified - add your badge logic here)
...
-- ============================================================================
-- FUNCTION: UPDATE CAPTAIN RATING
-- ============================================================================
...
-- Bookings: Users see their own, captains see theirs
CREATE POLICY "Users can view own bookings"
    ON public.bookings FOR SELECT
    USING (auth.uid() = user_id OR auth.uid() IN (
        SELECT user_id FROM public.captain_profiles WHERE id = bookings.captain_id
    ));
...
-- Fishing Reports: Public reports viewable by all
...
BEGIN
    ...
    Your charter booking platform database is ready!
    
    Tables Created:
    - ✅ User profiles & authentication
    - ✅ Captain profiles & boats
    - ✅ Bookings & reviews
    ...
    - ✅ Captain rating updates
    - ✅ Points system functions
    - ✅ 10 starter badges
    
    Next Steps:
    1. Configure authentication (Settings → Authentication)
    2. Set up email notifications (SMTP)
    3. Deploy weather alerts function
    4. Configure Stripe for payments
    5. Add your app URL to allowed domains
